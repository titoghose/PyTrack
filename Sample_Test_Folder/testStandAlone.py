...
generateCompatibleFormat(exp_path=os.path.abspath("Sample_Test_Folder/NTU_Experiment/Data/sub_222.asc"),
                        device="eyelink", 
                        stim_list_mode='NA', 
                        start='start_trial', 
                        stop='stop_trial', 
...
df = pd.read_csv(os.path.abspath("Sample_Test_Folder/NTU_Experiment/Data/sub_222.csv"))
...
stim = Stimulus(path=os.path.abspath("Sample_Test_Folder/NTU_Experiment"),
               data=df, 
